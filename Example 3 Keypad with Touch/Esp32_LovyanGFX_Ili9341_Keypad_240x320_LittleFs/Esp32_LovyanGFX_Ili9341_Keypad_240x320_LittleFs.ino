...
// The LittleFS (FLASH file system) is used to hold touch screen
// calibration data
...
// ### lgfx To avoid problems I'm using another filename for LovyanGFX calibration data
...
// ### lgfx gives problems in drawKeypad();
// definition is in https://github.com/lovyan03/LovyanGFX/blob/5438181440c71cf30bbdc347b0b1597ae3ebf77d/src/lgfx/v1/misc/enum.hpp#L74
// e.g. static constexpr int TFT_WHITE       = 0xFFFF;      /* 255, 255, 255 */
//uint16_t keyColor[15] = {TFT_RED, TFT_DARKGREY, TFT_DARKGREEN,
int keyColor[15] = { TFT_RED, TFT_DARKGREY, TFT_DARKGREEN,
...
void setup() {
  ...
  // ### lgfx I'm using a different method name
  //touch_calibrate();
...
Error: deduced conflicting types for parameter
       'const T' ('int' and 'uint16_t' {aka 'short unsigned int'})

Solution: change uint16_t keyColor[15] to int keyColor[15]
*/
