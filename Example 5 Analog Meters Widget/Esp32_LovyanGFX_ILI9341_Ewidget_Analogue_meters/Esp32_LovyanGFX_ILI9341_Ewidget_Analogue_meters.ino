...
#include <TFT_eWidget.h>  // Widget library https://github.com/Bodmer/TFT_eWidget
...
#include "LGFX_TFT_eSPI.h"  // ### added
LGFX tft;

// ### lgfx: has static constructors requiering the TFT_eSPI library
//#include <TFT_eWidget.h>  // Widget library https://github.com/Bodmer/TFT_eWidget
...
/*
  ...
  You find the modified library as zip file in the folder, please install it 
  by unzipping in 'Lovy_eWidget' folder and place this folder in the libraries folder:
  Lovy_eWidget.zip
*/
