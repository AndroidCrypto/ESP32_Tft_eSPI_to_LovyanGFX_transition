...
// Modified example to display the benchmark results

/*
  The original sketch/library was is using the 'Setup704_ESP32_DEFAULT_ILI9341_240x320.h'
	see the content in tab
...
// ### lgfx LovyanGFX has a built-in brightness control
// Backlight Pin
//const int pwmPin = 13;
...
void loop(void) {
	...
	Serial.print(F("Triangls outline "));
	...
	tft.println(F("  LovyanGFX library"));
	tft.println(F("  ILI9341 display"));

	tft.setTextColor(TFT_GREEN);
	tft.println(F("Benchmark  microsecs"));
	tft.println(F(""));
	tft.setTextColor(TFT_YELLOW);

	tft.setTextColor(TFT_CYAN);
	tft.setTextSize(txtSize);
	tft.print(F("HaD pushColr "));
	tft.setTextColor(TFT_YELLOW);
	tft.setTextSize(txtSize);
	printnice(usecHaD);
